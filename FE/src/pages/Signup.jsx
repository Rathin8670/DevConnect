...
export const Signup = () => {
    ...
    const [photoUrl, setPhotoUrl] = useState("https://support.hubstaff.com/wp-content/uploads/2019/08/good-pic.png");
            ...
            <div className="">
                ...
                <form>
                    ...
                    <div className="w-full rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                        <button type="button" className="w-full p-4 cursor-pointer"
